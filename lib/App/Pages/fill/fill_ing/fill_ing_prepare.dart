...
import 'package:soultec/App/Pages/fill/fill_ing/fill_ing_ing.dart';
...
class Filling_Prepare extends StatefulWidget {
  String? liter;
  String? car_number;
  ...
  @override
  _Filling_Prepare createState() => _Filling_Prepare();
}

class _Filling_Prepare extends State<Filling_Prepare> {
  //노르딕 디바이스 연결
        ...
        builder: (BuildContext context, AsyncSnapshot<List<int>> snapshot) {
          ...
          if (snapshot.connectionState == ConnectionState.active) {
               Navigator.push(
                   thiscontext,
                  MaterialPageRoute(
                     builder: (context) => Filling_ing(car_number: widget.car_number, liter: widget.liter)));
          }
          var currentValue;
